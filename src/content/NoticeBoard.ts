...
//   },

  {
    ...
    title: "특허 관련 안내사항",
    date: "2026-06-19",
    content: `- (주)아이리스랩은 2026년 6월 19일, 서비스 '틈틈'의 BM(Business Model) 및 백엔드/DB 로직에 대한 특허인 '이기종 태스크의 객체화 및 인공지능 기반 동적 보상 처리를 이용한 통합 서비스 제공 방법'을 출원했습니다.
- 출원번호 10-2026-0112698`,
  },
